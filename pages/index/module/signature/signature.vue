		...
		<view class="wrapper">
			<view class="handBtn">
				<image @click="selectColorEvent('black','#1A1A1A')"
					:src="selectColor === 'black' ? '/static/images/holdbarrage/color_black_selected.png' : '/static/images/holdbarrage/color_black.png'"
					:class="[selectColor === 'black' ? 'color_select' : '', 'black-select']"></image>
				<image @click="selectColorEvent('red','#ca262a')"
					:src="selectColor === 'red' ? '/static/images/holdbarrage/color_red_selected.png' : '/static/images/holdbarrage/color_red.png'"
